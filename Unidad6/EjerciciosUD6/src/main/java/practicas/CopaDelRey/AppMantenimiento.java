...
public class AppMantenimiento {
    ...
    public static void mostrarInfo() {
        ...
        String hola = "    Dentro podemos añadir jugadores, modificar datos y añadir acompañantes (solo Seniors).";
    ...
    static void modificarJugador() {
        ...
        int opcionDato = teclado.nextInt();
        ...
        switch (opcionDato) {
            case 1:
                ...
                if (nuevoNombre == jugadorSeleccionado.getNombre()) {
            ...
            case 3:
                ...
                Equipos nuevaCategoria = Equipos.valueOf(teclado.next().toUpperCase());
            ...
            case 5:
                ...
                Posiciones nuevaPosicion = Posiciones.valueOf(teclado.next().toUpperCase());
    ...
    public static void anyadirAcompanyante() {
        ...
        new Acompañante(nombre, edad, jugadorAcompanyado, parentesco);
    ...
    public static void anyadirEntrenador() {
        ...
        Equipos equipo = Equipos.valueOf(teclado.next().toUpperCase());
    ...
    static void modificarMasajista() {
        ...
        switch (opcionDato) {
            ...
            case 4:
                ...
                int nuevosAnyosExp = teclado.nextInt();
